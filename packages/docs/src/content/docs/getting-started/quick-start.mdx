---
title: Quick start
description: Get relay running in under 5 minutes — install the plugin, scan your project, then run your first multi-agent session.
---

import { Aside } from "@astrojs/starlight/components";

Four commands. That's all it takes to go from zero to a full team of AI agents working through your feature in parallel.
