---
title: Dashboard
description: The relay real-time dashboard shows a live Kanban board, agent message feed, and thought stream — with full session replay.
---
...
All events are persisted to SQLite. Use the session switcher in the dashboard to browse past sessions and replay the full sequence of events.
